...
# server_address = "145.100.135.84:8081"
...
run_folders = {
    ...
    "tsv_path": "/home/zahra/CAE.VAE/cam17_codes/Camelyon17/x_train.csv"
    # ,"tsv_path_val": "E:/Codes_prostatecancer/Prostate cancer/SICAPv2/SICAPv2/partition/Test/Test.csv"
    ,"tsv_path_test":"/home/zahra/CAE.VAE/cam17_codes/Camelyon17/x_val.csv"
    , "data_path": "/home/zahra/cam17_dataset/Original/"
    ,"model_path": '/home/zahra/breakhis_cam17_FDL/'
    , "results_path": '/home/zahra/breakhis_cam17_FDL/'
    , "log_filename": '/home/zahra/breakhis_cam17_FDL/log_cam17.csv'
}
...
label2=[]
x_train = pd.read_csv(run_folders["tsv_path"])
x_train.columns = ['index','image_name']

x_train=(x_train.iloc[:,:])
x_train=x_train["image_name"]

x_val = pd.read_csv(run_folders["tsv_path_test"])
x_val.columns = ['index','image_name']

x_val=(x_val.iloc[:,:])
x_val=x_val["image_name"]
...
class CBIRClient_cam17_20x(fl.client.NumPyClient):
    ...
    def get_parameters(self, config):
        ...
        with open(dirctory+'/res_get_paras_client1_cam17_20x.csv', 'a', encoding='UTF8') as f:
            writer = csv.writer(f)
